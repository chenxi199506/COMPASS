    ...
    fluidRow(
      column(12,
             ...
             div(class = "department-header",
                 h2(paste("🌍", "Global Research Distribution"), 
                    style = "margin: 0; font-weight: 700;"),
                 p("Visualizing worldwide RCT research collaboration patterns and geographic distribution - Hover over countries to see details", 
                   style = "margin: 5px 0 0 0; opacity: 0.8; font-size: 0.9rem;")
             )
      )
    ),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$selected_country_info <- renderUI({
      ...
      if (is.null(country_iso3)) {
        return(
          div(
            style = "text-align: center; padding: 20px; color: #666; font-family: 'Roboto', sans-serif;",
      ...
      div(
        h4(country_name, style = "color: #00695C; margin-top: 0; font-family: 'Montserrat', sans-serif;"),
        hr(),
        div(style = "font-size: 24px; font-weight: bold; color: #D73027; font-family: 'Montserrat', sans-serif;",
            paste0(round(country_stats$percentage, 2), "%")),
        div(style = "color: #666; font-size: 14px; font-family: 'Roboto', sans-serif;", "Global Share"),
        br(),
        div(style = "font-size: 20px; font-weight: bold; color: #4575B4; font-family: 'Montserrat', sans-serif;",
            country_stats$count),
        div(style = "color: #666; font-size: 14px; font-family: 'Roboto', sans-serif;", "Number of Studies"),
        br(),
        div(style = "font-size: 16px; color: #2E7D32; font-family: 'Roboto', sans-serif;",
            paste("Global Rank:", global_rank, "of", total_countries)),
        br(),
        div(style = "background: #E8F5E8; padding: 10px; border-radius: 5px; font-size: 12px; font-family: 'Roboto', sans-serif;",
    ...
    output$collaboration_network <- renderPlot({
      ...
      ggplot() +
        ...
        theme(
          ...
          plot.subtitle = element_text(family = "Roboto", size = 11, color = "grey40"),
          legend.position = "bottom",
          legend.box = "horizontal",
          legend.title = element_text(size = 9, face = "bold", family = "Montserrat"),
    ...
    output$total_citations_plot <- renderPlot({
      ...
      ggplot(plot_data) +
        ...
        theme_minimal() +
        theme(
          plot.title = element_text(size = 14, face = "bold", family = "Montserrat", color = "#2C3E50"),
          plot.subtitle = element_text(size = 10, color = "gray50", family = "Roboto"),
          axis.text.y = element_text(size = 10, face = "bold", family = "Montserrat"),
          axis.text.x = element_text(size = 9, family = "Roboto"),
          axis.title = element_text(size = 11, face = "bold", family = "Montserrat"),
    ...
    output$metrics_heatmap <- renderPlot({
      ...
      ggplot(heatmap_long, aes(x = variable, y = country_name)) +
        ...
        theme_minimal() +
        theme(
          plot.title = element_text(size = 14, face = "bold", hjust = 0.5, family = "Montserrat", color = "#2C3E50"),
          plot.subtitle = element_text(size = 10, color = "gray0", hjust = 0.5, family = "Roboto"),
          axis.text.x = element_text(size = 10, face = "bold", angle = 45, hjust = 1, family = "Montserrat"),
          axis.text.y = element_text(size = 10, face = "bold", family = "Montserrat"),
          axis.title = element_text(size = 11, face = "bold", family = "Montserrat"),
          legend.position = "right",
          legend.title = element_text(face = "bold", family = "Montserrat"),
          panel.grid = element_blank(),
          panel.background = element_rect(fill = "white", color = NA),
          plot.background = element_rect(fill = "white", color = NA)
        )
