...
source("01umar_database_module24.R")
...
meta_db <- readRDS("database251103")
#meta_db$country_standardized
    ...
    fluidRow(
      ...
      column(12,
             div(style = "text-align: center; position: relative; z-index: 2;",
                 ...
                 p("Comprehensive Online Meta-Analysis Platform for Smart Synthesis", 
                   class = "main-subtitle"),
...
#rsconnect::setAccountInfo(name='chatgptmodel', token='BCC5C01AB7B75E2F923D3EE2F36C4BD3', secret='Oww242805JI+x14G+3oFzaXbV+QdF0H7ikooQ4z0')
