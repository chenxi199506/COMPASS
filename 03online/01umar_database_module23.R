  ...
  tagList(
    ...
    fluidPage(
      ...
      div(class = "external-meta-header",
          fluidRow(
            column(8,
                   h2("🌐 Advanced Meta-Analysis Database", 
                      style = "margin: 0; font-weight: 800; font-size: 2.2rem;"),
                   p("Comprehensive collection of published meta-analyses with detailed effect size data", 
      ...
      fluidRow(
        column(3,
               div(class = "stats-card-external",
                   ...
                   p("Meta-analysis records", style = "color: #7f8c8d; margin: 0; font-size: 12px;")
               )
        ),
        column(3,
               div(class = "stats-card-external",
          ...
          fluidRow(
            column(12,
                   div(class = "database-info",
                       fluidRow(
                         column(6,
                                h4("📋 Meta-Analysis Overview", style = "margin: 0; font-weight: 600;"),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$database_stats <- renderUI({
      ...
      tagList(
        ...
        p(paste(format(nrow(data), big.mark = ","), "meta-analyses"), 
          style = "margin: 0; font-size: 12px;")
      )
    })
